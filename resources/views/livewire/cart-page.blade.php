            ...
            <tbody>
              ...
              <tr wire:key='{{ $item["product_id"] }}'>
                ...
                <td>
                  ...
                  hover:border-red-700"><span wire:loading.remove wire:target='removeItem({{ $item["product_id"] }})'>Quitar</span><span wire:loading wire:target='removeItem({{ $item["product_id"] }})'>Quitando...</span></button>
                </td>
              </tr>
              @empty
                <tr>
