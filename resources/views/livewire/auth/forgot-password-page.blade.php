            ...
            <form method="POST" action="{{ route('password.email') }}">
              ...
              <div class="grid gap-y-4">
                ...
                <div>
                  ...
                  <p class="hidden text-xs text-red-600 mt-2" id="email-error">Incluye una dirección de correo electrónico válida para que podamos enviarte el enlace de recuperación</p>
                </div>
