  ...
  <section class="overflow-hidden bg-white py-11 font-poppins dark:bg-gray-800">
    <div class="max-w-6xl px-4 py-4 mx-auto lg:py-8 md:px-6">
      <div class="flex flex-wrap -mx-4">
        <!-- Parte de la imagen principal con Alpine.js -->
          ...
          <div class="lg:pl-20">
            <div class="mb-8 ">
              ...
              <p class="inline-block mb-6 text-4xl font-bold text-gray-700 dark:text-gray-400 ">
                ...
                <span class="text-base font-normal text-gray-500 line-through dark:text-gray-400">{{ $product->original_price }}</span>
              </p>
            ...
            <div class="flex flex-wrap items-center gap-4">
              ...
              hover:bg-blue-600 dark:bg-blue-500 dark:hover:bg-blue-700">
                <span wire:loading.remove>Añadir al carrito</span><span wire:loading>Añadiendo...</span>
              </button>
            </div>
          </div>
        </div>
